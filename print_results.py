...
##
# DONE6: Define print_results function below, specifically replace the None
...
def print_results(results_dic, results_stats_dic, model, 
    ...
    if (print_incorrect_dogs and 
        ...
        for key in results_dic:
            ...
            if results_dic[key][3] == 1 and results_dic[key][4] == 0: # if Pet Image Lable is a Dog - Classified as NOT-A-DOG
                print("Pet Label: {} and Classifier Lable: {} . ".format(results_dic[key][0], results_dic[key][1]))
            
            #
            if results_dic[key][3] == 0 and results_dic[key][4] == 1: # if Pet Image Lable is NOT-a-Dog - Classified as a-DOG
                print("Pet Label: {} and Classifier Lable: {} . ".format(results_dic[key][0], results_dic[key][1]))
