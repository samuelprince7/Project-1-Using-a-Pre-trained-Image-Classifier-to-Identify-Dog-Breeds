...
def main():
    ...
    results = get_pet_labels(in_arg.dir) #777 edit to check PetLables dict
    ...
    classify_images(in_arg.dir, results, in_arg.arch) #777 edit to check classifer results against the Pet Labels dict
    ...
    adjust_results4_isadog(results, in_arg.dogfile) #777 edit to check is a dog in PetLabels and ClassifierLabels [(1,1)(1,0)(0,1)(0,0)]
