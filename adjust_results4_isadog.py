...
#           that's the 'value' of the results dictionary. You will be adding them
...
def adjust_results4_isadog(results_dic, dogfile):
    ...
    with open(dogfile, "r") as infile:
        ...
        line = infile.readline() # reads the 1st line then continues w/next line at the bottom of while loop
        ...
        while line != "":
            ...
            if line in dognames_dic:
                print("Warning, there is a duplicate dog name in dognames.txt")
            else:
                dognames_dic[line] = dognames_dic.get(line, 1)# if line does not exist in dict,then creates it as a key with the value 1

            # Reads in next line in file to be processed with while loop
            # if this line isn't empty (EOF)
            line = infile.readline()

    ##777 at this point the dognames_dic is created with each name from dognames.txt as the key and it's value is 1
    ...
    for key in results_dic:
        ...
        if results_dic[key][0] in dognames_dic:
            ...
            if results_dic[key][1] in dognames_dic:
                results_dic[key].extend((1, 1)) #777up to this point,the scenario where PetLable IS dog AND ClassiferLable IS dog is taken care of
            ...
            # appends (1,0) because only pet label is a dog
                ...
                results_dic[key].extend((1, 0)) #777 this runs IF PetLable IS dog, but ClassiferLable is-NOT dog. 2 of 4 possible scenarios resolved.
